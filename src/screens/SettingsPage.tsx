...
const auditLabels: Record<string, string> = {
  ...
  schema_migrated: "Base de données mise à jour",
  product_created: "Produit créé",
  product_updated: "Produit modifié",
  product_archived: "Produit archivé",
  product_sale_created: "Vente de produits enregistrée",
  stock_received: "Réapprovisionnement enregistré",
  stock_adjusted: "Stock corrigé après comptage",
  product_operation_cancelled: "Opération de stock annulée",
